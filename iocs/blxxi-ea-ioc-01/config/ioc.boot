...
dbLoadRecords (simDetector.template, "P=BLXXI-EA-PCO-01, R=:CAM:, PORT=PCO.CAM, TIMEOUT=1, ADDR=0")
dbLoadRecords (NDPva.template, "P=BLXXI-EA-PCO-01, R=:PVA:, PORT=PCO.PVA, ADDR=0, TIMEOUT=1, NDARRAY_PORT=PCO.CAM, NDARRAY_ADR=0, ENABLED=1")
